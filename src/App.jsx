      ...
      <div style={{width:230,background:C.surface,borderRight:`1px solid ${C.border}`,display:'flex',flexDirection:'column',overflow:'hidden',flexShrink:0}}>
        ...
        <div style={{overflowY:'auto',flex:1,padding:'8px 0'}}>
          {TITLES.map((title,i)=>{
            ...
            return(
              <button key={i} onClick={()=>setChapter(i)} style={{width:'100%',textAlign:'left',background:active?`${ac}15`:'transparent',border:'none',borderLeft:active?`3px solid ${ac}`:'3px solid transparent',padding:'9px 14px',cursor:'pointer',transition:'all 0.15s'}}>
